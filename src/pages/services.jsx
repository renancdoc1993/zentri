...
import { 
  ...
  Layers, 
  Layout,
  X // Importado para usar no botão inferior
} from 'lucide-react';
    ...
    return (
        ...
        >
            {/* REMOVI O BOTÃO FLUTUANTE DAQUI 
               O único botão de fechar agora está no final do conteúdo 
            */}
            ...
            >
                ...
                <div className="lg:w-1/3 p-6 lg:p-10 overflow-y-auto flex flex-col">
                    ...
                    {/* BOTÕES DE AÇÃO (FINAL DA COLUNA) */}
                    <div className="mt-8 space-y-3">
                        ...
                        <a 
                            ...
                            target="_blank" 
                            rel="noreferrer" 
                            className="inline-flex w-full items-center justify-center gap-2 bg-zentri-main text-black py-4 rounded-xl font-bold hover:bg-white transition-all shadow-lg active:scale-95"
                        >
                            Ver Projeto Online <ExternalLink size={18} />
                        </a>

                        {/* Botão Fechar (AGORA AQUI EMBAIXO) */}
                        <button 
                            onClick={onClose}
                            className="w-full flex items-center justify-center gap-2 py-4 rounded-xl border border-white/10 text-gray-400 font-bold hover:text-white hover:bg-white/5 transition-all active:scale-95"
                        >
                            Fechar Detalhes <X size={18} />
                        </button>
                    </div>
                </div>
            </div>
