    ...
    <div className="text min-h-screen overflow-hidden">
      ...
      <section className="pt-32 pb-20 px-4 border-b border-zentri-muted/50 relative">
         ...
         <div className="max-w-7xl mx-auto grid lg:grid-cols-5 gap-12 items-center relative z-10 text-center lg:text-left">
            ...
            {/* Ajustado: items-center (mobile) para items-start (desktop) */}
            <FadeIn direction="right" className="lg:col-span-2 flex flex-col items-center lg:items-start">
                ...
                {/* Ajustado: mx-auto (mobile) para lg:mx-0 (desktop) */}
                ...
                {/* Ajustado: justify-center (mobile) para lg:justify-start (desktop) */}
            ...
            <FadeIn direction="left" delay={0.2} className="relative lg:col-span-3">
                <div className="relative z-10 rounded-2xl overflow-hidden shadow-2xl border border-white/10 group">
                    ...
                    {/* Badge flutuante ajustada para mobile/desktop */}
      ...
      <section className="py-20 px-4 max-w-7xl mx-auto">
        <FadeIn className="flex flex-col items-center lg:items-start mb-12">
      ...
      {/* ... Restante do código (Processo, FAQ e CTA) permanecem iguais ... */}
      {/* (Mantive a lógica de centralização apenas onde é necessária para mobile) */}
...
// --- Sub-componentes Ajustados ---

const ServiceCard = ({ icon, title, description, features }) => (
    <FadeIn className="group bg-zentri-card p-8 rounded-3xl border border-zentri-muted hover:border-zentri-main transition-all duration-300 flex flex-col items-center lg:items-start text-center lg:text-left">
        <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-zentri-main mb-6 border border-white/5 mx-auto lg:mx-0">
            {icon}
        </div>
        <h3 className="text-xl font-bold text-white mb-3 w-full">{title}</h3>
        <h2 className="text-gray-400 opacity-70 mb-6 text-sm min-h-[40px]">{description}</h2>
